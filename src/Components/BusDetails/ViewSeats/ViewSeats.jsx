...
const ViewSeats = ({
  ...
  React.useEffect(() => {
    dispatch(updateBookingDetails({ key: "seats", value: selectedSeats }));
    dispatch(updateBookingDetails({ key: "fare", value: selectedSeats.length * seatPrice }));
  }, [selectedSeats, seatPrice, dispatch]);

  React.useEffect(() => {
    dispatch(updateBookingDetails({ key: "busId", value: busId.toString() }));
  }, [busId, dispatch]);
  ...
  const columns = Math.ceil(totalSeats / seatsPerColumn);
  ...
  return (
    <div className={styles.mainContainer}>
      <div className={styles.mainContainer1}>
        ...
        <div className={styles.mainContainer1Right}>
          {Array.from({ length: columns }).map((_, colIndex) => {
            const colSeats = allSeats.slice(colIndex * seatsPerColumn, (colIndex + 1) * seatsPerColumn);            return (
              <div key={colIndex}>
                {colSeats.map((seatNo) => (
                  <SmallSeat
                    key={seatNo}
      ...
      {selectedSeats.length === 0 && (
        <div className={styles.mainContainer2}>
          <div className={styles.mainContainer21}>
            ...
            <div>
              <div>
                <CheckBoxOutlineBlankIcon style={{ backgroundColor: "black", borderRadius: "4px", border: "0px" }} />
                &nbsp;&nbsp;
                <span>Available</span>
              </div>
              <div>
                <CheckBoxOutlineBlankIcon style={{ backgroundColor: "red", borderRadius: "4px", border: "0px" }} />
                &nbsp;&nbsp;
      ...
      {boardAndDrop && selectedSeats.length > 0 && (
        <div className={styles.mainContainer3}>
          <div className={styles.mainContainer31}>
            ...
            <div onClick={() => setBoardAndDrop(false)}>CHANGE</div>
          </div>
          <div className={styles.mainContainer32}>
            ...
            <div style={{ fontSize: "16px", color: "#4a4a4a", fontWeight: "700" }}>{busDepartureTime}:00</div>
          </div>
          <div className={styles.mainContainer33}>
            ...
            <div style={{ fontSize: "16px", color: "#4a4a4a", fontWeight: "700" }}>{busArrivalTime}:00</div>
          </div>
          <Divider />
          ...
          <div className={styles.mainContainer36}>
            <div>
              ...
              <br></br>
              <span style={{ fontSize: "10px", color: "#838083", marginTop: "5px" }}>
      ...
      {!boardAndDrop && selectedSeats.length > 0 && (
        <SubRoutes
          handleBoardAndDrop={() => setBoardAndDrop(true)}
