...
const BusBookingForm = () => {
  ...
  for (let ele = 0; ele < seatsArray.length; ele++) {
    passengerArray.push({
      name: "",
      age: "",
      gender: "",
    ...
    <div style={{ border: "1px solid black" }}>
      ...
      >
        {seatsArray.map((seatNo, index) => {
          return (
            <div className={Styles.ContentBlock} key={`seat-${seatNo}`}>
      ...
      <div className={Styles.ContentBlock}>
        ...
        <div className={Styles.insure_title}>
          Insure your travel by adding Rs 15 per passenger. Powered by ACKO
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          />
          <div style={{ marginLeft: "10px" }}>
            Yes, secure my trip with insurance. I have read and understood the terms and conditions.
          </div>
        </div>
        <div
          style={{
